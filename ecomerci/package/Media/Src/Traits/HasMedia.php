...
namespace Module\Media\Src\Traits;

use Module\Media\Src\Models\Media;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Database\Eloquent\Relations\MorphToMany;
use Module\Media\Src\MediaChannel;
...
trait HasMedia
{
    ...
    {
        return $this
            ->morphToMany(config('media.models.media'), 'mediable', config('media.tables.mediables'))
            ->withPivot('channel');
