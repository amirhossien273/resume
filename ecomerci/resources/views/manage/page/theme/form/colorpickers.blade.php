...
@section('style')
<!-- Color Picker css -->
<link href="{{ asset('/assets/manage/plugins/colorpicker/bootstrap-colorpicker.css') }}" rel="stylesheet" type="text/css">
@endsection
...
@section('script')
<!-- Color Picker js -->
<script src="{{ asset('/assets/manage/plugins/colorpicker/bootstrap-colorpicker.js') }}"></script>
<script src="{{ asset('/assets/manage/js/custom/custom-form-colorpicker.js') }}"></script>
@endsection
