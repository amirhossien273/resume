        ...
        <div class="col-lg-6">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text">First and نام خانوادگی</span>
                        </div>
                        <input type="text" aria-label="نام" class="form-control">
                        <input type="text" aria-label="نام خانوادگی" class="form-control">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
