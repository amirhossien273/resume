                            ...
                            <form id="basic-form-wizard" action="#">
                                <div>
                                    ...
                                    <section>
                                        ...
                                        <ul>
                                            <li><strong>نام :</strong> John</li>
                                            <li><strong>نام خانوادگی :</strong> Doe</li>
                            ...
                            <form id="vertical-form-wizard" action="#">
                                <div>
                                    ...
                                    <section>
                                        ...
                                        <div class="form-group">
                                            <label for="verticalconfirmPassword">تکرار رمز عبور</label>
                                    ...
                                    <section>
                                        <h4 class="font-22 mb-3">Setup Your Profile !!!</h4>
                                        <div class="form-group">
                                            <label for="verticalfirstname">نام</label>
                                            <input type="text" class="form-control" id="verticalfirstname">
                                        </div>
                                        <div class="form-group">
                                            <label for="verticallastname">نام خانوادگی</label>
