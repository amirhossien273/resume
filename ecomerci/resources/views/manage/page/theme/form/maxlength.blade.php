...
@section('script')
<!-- MaxLength js -->
<script src="{{ asset('/assets/manage/plugins/bootstrap-maxlength/bootstrap-maxlength.js') }}"></script>
<script src="{{ asset('/assets/manage/js/custom/custom-form-maxlength.js') }}"></script>
@endsection
