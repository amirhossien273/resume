                    ...
                    <form class="needs-validation" novalidate>
                      <div class="form-row">
                        <div class="col-md-4 mb-3">
                          ...
                          <input type="text" class="form-control" id="validationCustom01" placeholder="نام" value="Mark" required>
                        ...
                        <div class="col-md-4 mb-3">
                          ...
                          <input type="text" class="form-control" id="validationCustom02" placeholder="نام خانوادگی" value="Otto" required>
                          <div class="valid-feedback">
                            Looks good!
                          </div>
                        </div>
                    ...
                    <form class="needs-validation" novalidate>
                      <div class="form-row">
                        <div class="col-md-4 mb-3">
                          ...
                          <input type="text" class="form-control" id="validationTooltip01" placeholder="نام" value="Mark" required>
                        ...
                        <div class="col-md-4 mb-3">
                          ...
                          <input type="text" class="form-control" id="validationTooltip02" placeholder="نام خانوادگی" value="Otto" required>
                          <div class="valid-tooltip">
                            Looks good!
                          </div>
                        </div>
                    ...
                    <form>
                      <div class="form-row">
                        <div class="col-md-4 mb-3">
                          ...
                          <input type="text" class="form-control" id="validationDefault01" placeholder="نام" value="Mark" required>
                        </div>
                        <div class="col-md-4 mb-3">
                          <label for="validationDefault02">نام خانوادگی</label>
                          <input type="text" class="form-control" id="validationDefault02" placeholder="نام خانوادگی" value="Otto" required>
                        </div>
                        <div class="col-md-4 mb-3">
                    ...
                    <form>
                      <div class="form-row">
                        <div class="col-md-4 mb-3">
                          ...
                          <input type="text" class="form-control is-valid" id="validationServer01" placeholder="نام" value="Mark" required>
                          <div class="valid-feedback">
                            Looks good!
                          </div>
                        </div>
                        <div class="col-md-4 mb-3">
                          ...
                          <input type="text" class="form-control is-valid" id="validationServer02" placeholder="نام خانوادگی" value="Otto" required>
                          <div class="valid-feedback">
                            Looks good!
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                    ...
                                    <span class="css-control-indicator"></span> I agree to the terms & conditions of Shabdar
                                </label>
                            </div>
                        </div>
                        <div class="form-group row">
...
@section('script')
<!-- Parsley js -->
<script src="{{ asset('/assets/manage/plugins/validatejs/validate.min.js') }}"></script>
<!-- Validate js -->
<script src="{{ asset('/assets/manage/js/custom/custom-validate.js') }}"></script>
<script src="{{ asset('/assets/manage/js/custom/custom-form-validation.js') }}"></script>
@endsection
