...
@section('style')
<!-- Datepicker css -->
<link href="{{ asset('/assets/manage/plugins/datepicker/datepicker.min.css') }}" rel="stylesheet" type="text/css">
@endsection
...
@section('script')
<!-- Datepicker JS -->
<script src="{{ asset('/assets/manage/plugins/datepicker/datepicker.min.js') }}"></script>
<script src="{{ asset('/assets/manage/plugins/datepicker/i18n/datepicker.en.js') }}"></script>
<script src="{{ asset('/assets/manage/js/custom/custom-form-datepicker.js') }}"></script>
@endsection
