...
@section('script')
<!-- Input Mask js -->
<script src="{{ asset('/assets/manage/plugins/bootstrap-inputmask/jquery.inputmask.bundle.min.js') }}"></script>
<script src="{{ asset('/assets/manage/js/custom/custom-form-inputmask.js') }}"></script>
@endsection
