...
@section('style')
<!-- Touchspin css -->
<link href="{{ asset('/assets/manage/plugins/bootstrap-touchspin/jquery.bootstrap-touchspin.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Touchspin js -->
<script src="{{ asset('/assets/manage/plugins/bootstrap-touchspin/jquery.bootstrap-touchspin.min.js') }}"></script>
<script src="{{ asset('/assets/manage/js/custom/custom-form-touchspin.js') }}"></script>
@endsection
