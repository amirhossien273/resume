...
<script src="{{ asset('/assets/manage/plugins/jquery-bar-rating/jquery.barrating.min.js') }}"></script>
<script src="{{ asset('/assets/manage/js/custom/custom-barrating.js') }}"></script>
@endsection
