...
@section('style')
<!-- Nestable css -->
<link href="{{ asset('/assets/manage/plugins/nestable/jquery.nestable.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Nestable js -->
<script src="{{ asset('/assets/manage/plugins/nestable/jquery.nestable.min.js') }}"></script>
<script src="{{ asset('/assets/manage/js/custom/custom-nestable.js') }}"></script>
@endsection
