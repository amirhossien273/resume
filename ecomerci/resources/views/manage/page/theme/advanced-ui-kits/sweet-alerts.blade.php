...
@section('style')
<!-- Sweet Alert css -->
<link href="{{ asset('/assets/manage/plugins/sweet-alert2/sweetalert2.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Sweet-Alert js -->
<script src="{{ asset('/assets/manage/plugins/sweet-alert2/sweetalert2.min.js') }}"></script>
<script src="{{ asset('/assets/manage/js/custom/custom-sweet-alert.js') }}"></script>
@endsection
