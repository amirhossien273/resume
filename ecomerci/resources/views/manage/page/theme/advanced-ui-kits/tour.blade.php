...
@section('style')
<!-- Product Tour css -->
<link href="{{ asset('/assets/manage/plugins/product-tour/product-tour.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
<div class="contentbar">
    ...
    <div class="row tourbar">
        ...
        <!-- Start col -->
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="card m-b-30" id="tour-spinner">
                <div class="card-header">
...
<!-- Product Tour js -->
<script src="{{ asset('/assets/manage/plugins/product-tour/product-tour.min.js') }}"></script>
<script src="{{ asset('/assets/manage/js/custom/custom-tour.js') }}"></script>
@endsection
