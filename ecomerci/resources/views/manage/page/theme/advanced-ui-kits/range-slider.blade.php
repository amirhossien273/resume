...
@section('style')
<!-- Range Slider css -->
<link href="{{ asset('/assets/manage/plugins/ion-rangeSlider/ion.rangeSlider.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
<script src="{{ asset('/assets/manage/js/custom/custom-range-slider.js') }}"></script>
@endsection
