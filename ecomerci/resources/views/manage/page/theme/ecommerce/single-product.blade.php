                            ...
                            <div class="col-lg-6 col-xl-5">
                                <div class="product-slider-box product-box-for">
                                    <div class="product-preview">
                                        <img src="/assets/manage/images/ecommerce/product_img_01.jpg" class="img-fluid"
                                             alt="Product">
                                        <p><span class="badge badge-success font-14">25% off</span></p>
                                    </div>
                                    <div class="product-preview">
                                        <img src="/assets/manage/images/ecommerce/product_img_02.jpg" class="img-fluid"
                                             alt="Product">
                                        <p><span class="badge badge-primary font-14">New</span></p>
                                    </div>
                                    <div class="product-preview">
                                        <img src="/assets/manage/images/ecommerce/product_img_03.jpg" class="img-fluid"
                                             alt="Product">
                                        <p><span class="badge badge-danger font-14">Price Drop</span></p>
                                    </div>
                                    <div class="product-preview">
                                        <img src="/assets/manage/images/ecommerce/product_img_04.jpg" class="img-fluid"
                                             alt="Product">
                                        <p><span class="badge badge-success font-14">Sale</span></p>
                                    </div>
                                    <div class="product-preview">
                                        <img src="/assets/manage/images/ecommerce/product_img_05.jpg" class="img-fluid"
                                             alt="Product">
                                        <p><span class="badge badge-warning font-14">Trending</span></p>
                                    </div>
                                    <div class="product-preview">
                                        <img src="/assets/manage/images/ecommerce/product_img_06.jpg" class="img-fluid"
                                             alt="Product">
                            ...
                            <div class="col-lg-6 col-xl-7">
                                ...
                                <div class="custom-radio-button mt-3">
                                    ...
                                    <div class="form-check-inline radio-primary">
                                        <input type="radio" id="customRadioInline5" name="customRadioInline2" class=""
                                               checked>
                                ...
                                <div class="button-list mt-5 mb-5">
                                    <button type="button" class="btn btn-danger-rgba font-18"><i
                                            class="feather icon-heart"></i></button>
                                    <button type="button" class="btn btn-primary-rgba font-18"><i
                                            class="feather icon-shopping-bag mr-2"></i>Add to Cart
                                    </button>
                                ...
                                <div class="button-list">
                                    ...
                                    <a href="#" class="btn btn-warning-rgba font-18"><i
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs custom-tab-line mb-3" id="defaultTabLine" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="review-tab-line" data-toggle="tab" href="#review-line"
                                   role="tab" aria-controls="review-line" aria-selected="false"><i
                                        class="feather icon-star mr-2"></i>Review</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="guide-tab-line" data-toggle="tab" href="#guide-line" role="tab"
                                   aria-controls="guide-line" aria-selected="false"><i
                                        class="feather icon-book-open mr-2"></i>Guide</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="defaultTabContentLine">
                            ...
                            <div class="tab-pane fade" id="review-line" role="tabpanel"
                                ...
                                <ul class="list-unstyled">
                                    <li class="media">
                                        <img src="/assets/manage/images/users/men.svg" class="img-fluid ml-3"
                                             alt="user">
                                    ...
                                    <li class="media my-4">
                                        <img src="/assets/manage/images/users/boy.svg" class="img-fluid ml-3"
                                             alt="user">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img src="/assets/manage/images/users/girl.svg" class="img-fluid ml-3"
                                             alt="user">
                                        <div class="media-body">
...
@section('script')
    ...
    <script src="{{ asset('/assets/manage/js/custom/custom-ecommerce-single-product.js') }}"></script>
@endsection
