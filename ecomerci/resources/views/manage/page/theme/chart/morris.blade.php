...
@section('style')
<!-- Morris Chart css -->
<link href="{{ asset('/assets/manage/plugins/morris/morris.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
<!-- Morris Chart js -->
<script src="{{ asset('/assets/manage/plugins/morris/morris.min.js') }}"></script>
<script src="{{ asset('/assets/manage/plugins/raphael/raphael-min.js') }}"></script>
<script src="{{ asset('/assets/manage/js/custom/custom-chart-morris.js') }}"></script>
@endsection
