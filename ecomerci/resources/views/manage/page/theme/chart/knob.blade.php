...
@section('script')
<!-- Knob Chart js -->
<script src="{{ asset('/assets/manage/plugins/jquery-knob/excanvas.js') }}"></script>
<script src="{{ asset('/assets/manage/plugins/jquery-knob/jquery.knob.min.js') }}"></script>
<script src="{{ asset('/assets/manage/js/custom/custom-chart-knob.js') }}"></script>
@endsection
