...
@section('script')
<!-- Sparkline Chart JS -->
<script src="{{ asset('/assets/manage/plugins/jquery-sparkline/jquery.sparkline.min.js') }}"></script>
<script src="{{ asset('/assets/manage/js/custom/custom-chart-sparkline.js') }}"></script>
@endsection
