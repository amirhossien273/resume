...
@section('style')
<!-- Footabel css -->
<link href="{{ asset('/assets/manage/plugins/footable/css/footable.bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
<script src="{{ asset('/assets/manage/plugins/footable/js/footable.min.js') }}"></script>
<script src="{{ asset('/assets/manage/js/custom/custom-table-footable.js') }}"></script>
@endsection
