        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <h6 class="card-subtitle">Bootstrap includes several predefined button styles, each serving its own semantic purpose, with a few extras thrown in for more control.</h6>
                    <div class="button-list">
                        <button type="button" class="btn btn-outline-primary"><i class="feather icon-send ml-2"></i> Submit</button>
                        <button type="button" class="btn btn-outline-secondary"><i class="feather icon-save ml-2"></i> Save</button>
                        <button type="button" class="btn btn-outline-success"><i class="feather icon-plus ml-2"></i> Insert</button>
                        <button type="button" class="btn btn-outline-warning"><i class="feather icon-upload ml-2"></i> Update</button>
                        <button type="button" class="btn btn-outline-danger"><i class="feather icon-trash-2 ml-2"></i> Delete</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <h6 class="card-subtitle">Bootstrap includes several predefined button styles, each serving its own semantic purpose, with a few extras thrown in for more control.</h6>
                    <div class="button-list">
                        <button type="button" class="btn btn-primary-rgba"><i class="feather icon-send ml-2"></i> Submit</button>
                        <button type="button" class="btn btn-secondary-rgba"><i class="feather icon-save ml-2"></i> Save</button>
                        <button type="button" class="btn btn-success-rgba"><i class="feather icon-plus mrl2"></i> Insert</button>
                        <button type="button" class="btn btn-warning-rgba"><i class="feather icon-upload ml-2"></i> Update</button>
                        <button type="button" class="btn btn-danger-rgba"><i class="feather icon-trash-2 ml-2"></i> Delete</button>
                    </div>
                </div>
            </div>
        </div>
