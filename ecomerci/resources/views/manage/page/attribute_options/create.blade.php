            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="card-title">ثبت حالت جدید</h5>
                    </div>
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('manage.attribute_options.store') }}">
                            @csrf
                            <input type="hidden" id="attribute_id" name="attribute_id" value="{{request()->route('attribute')}}">
                            <div class="form-row">
