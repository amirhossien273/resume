            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="card-title">ویرایش بنر </h5>
                    </div>
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('manage.sliders.update', $slider->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-row">
                                   <div class="mt-2 col-md-12 mb-3">
                                        <img style="width: 100%;" src="{{ $slider->getFirstMediaUrl('slider') }}" alt="{{ $slider->title }}">
                                    </div>
                               <div class="col-md-12 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="intro" name="intro" placeholder="Intro" value="{{ $slider->intro }}">
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label for="intro">لینک</label>
                                    <input type="url" class="form-control" id="url" name="url" placeholder="url" value="{{ $slider->url }}">
                                </div>
                                <div class="col-md-12 mb-3">
