            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="card-title">ثبت ویژگی جدید</h5>
                    </div>
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('manage.variation_options.store') }}">
                            @csrf
                            <input type="hidden" id="variation_id" name="variation_id" value="{{request()->route('variation')}}">
                            <div class="form-row">
