            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h5 class="card-title">ویرایش تگ </h5>
                    </div>
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('manage.tags.update', $tag->id) }}">
                            @csrf
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" placeholder="نام" value="{{ old('title', $tag->title) }}" required>
                                </div>
