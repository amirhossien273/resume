            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('manage.categories.update', $category->id) }}"  enctype="multipart/form-data">
                            @csrf
                            @method('PUT') <!-- Use PATCH method for updating -->

                            <div class="form-row">
                                <div class="mt-2 col-md-12 mb-3">
                                    <img style="width: 100%;" src="{{ $category->getFirstMediaUrl('category') }}" alt="{{ $category->title }}">
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" placeholder="نام" value="{{ old('title', $category->title) }}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="slug">slug</label>
                                    <input type="text" class="form-control" id="slug" name="slug" placeholder="slug" value="{{ old('slug', $category->slug) }}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="show_order">الویت نمایش</label>
                                    <input type="text" class="form-control" id="show_order" name="show_order" placeholder="الویت نمایش" value="{{ old('show_order', $category->show_order) }}" required>
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label for="content">محتوا</label>
                                    <textarea id="tinymce-example" name="content" class="form-control">{{ old('content', $category->content) }}</textarea>
                                </div>
                            </div>
