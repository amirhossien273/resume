<x-layout.default>
    ...
    <div class="pt-5 grid grid-cols-12 lg:grid-cols-12">
        ...
        <div class="panel">
            <h3 class="text-lg font-bold mb-5">افزودن لید جدید</h3>
            @if ($errors->any())
            ...
            <form action="{{ route('lead.store') }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 hidden" id="company_info">
                    <div class="grid grid-cols-12 gap-2 items-center">
                        ...
                        <input name="company" id="company" type="text" class="form-input col-span-8" required value="{{ old('company') }}"/>
                    </div>
                    <div class="grid grid-cols-12 gap-2 items-center">
                        <label for="phone" class="col-span-4 text-right">تلفن شرکت</label>
                        <input name="company_phone" id="phone" type="text" class="form-input col-span-8" value="{{ old('company_phone') }}"/>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="grid grid-cols-12 gap-2 items-center">
                        ...
                        <input name="firstname" id="firstname" type="text" class="form-input col-span-8" required value="{{ old('firstname') }}"/>
                    </div>

                    <div class="grid grid-cols-12 gap-2 items-center">
                        <label for="lastname" class="col-span-4 text-right">نام خانوادگی</label>
                        <input name="lastname" id="lastname" type="text" class="form-input col-span-8" required value="{{ old('lastname') }}"/>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="grid grid-cols-12 gap-2 items-center">
                        ...
                        <input name="mobile" id="mobile" type="text" class="form-input col-span-8" required value="{{ old('mobile') }}"/>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="grid grid-cols-12 gap-2 items-center">
                        ...
                        <select name="province_id" id="province" class="selectize col-span-8">
                    ...
                    <div class="grid grid-cols-12 gap-2 items-center">
                        ...
                        <select name="city_id" id="city" class="selectize col-span-8"></select>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-12 gap-2 items-center">
                    ...
                    <textarea name="address" id="address" minlength="20" rows="3" class="form-textarea col-span-10" required>{{old('address')}}</textarea>
                </div>

                <button type="submit" class="btn btn-primary mt-6">ثبت لید</button>
            </form>
        </div>
