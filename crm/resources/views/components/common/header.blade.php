            ...
            <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                <a href="/" class="main-logo flex items-center shrink-0">
                    ...
                    <img class="w-8 ltr:-ml-1 rtl:-mr-1 inline"
                        :src="theme === 'light' ? '/assets/images/Alogo.png' : '/assets/images/logo.png'"
                        alt="image" />
                    <img x-show="$store.app.theme === 'dark'" class="w-8 ml-[5px] flex-none" src="/assets/images/Alogo.png"
                        alt="image" />
                    <span class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">Artan Tejarat</span>
                </a>
