        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img x-show="$store.app.theme !== 'dark'" class="w-8 ml-[5px] flex-none" src="/assets/images/logo.png"
                        alt="image" />
                    <img x-show="$store.app.theme === 'dark'" class="w-8 ml-[5px] flex-none" src="/assets/images/Alogo.png"
                        alt="image" />
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">Artan Tejarat</span>
                </a>
                <a href="javascript:;"
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        ...
                        <div class="flex items-center">
                            ...
                            <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24"
                                 fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5" d="M4 6H20" stroke="currentColor" stroke-width="2"/>
                                <path opacity="0.5" d="M4 12H20" stroke="currentColor" stroke-width="2"/>
                                <path opacity="0.5" d="M4 18H20" stroke="currentColor" stroke-width="2"/>
                            </svg>

                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">معاملات</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'transaction'" x-collapse
                        ...
                        <li>
                            <a href="/transaction/create">افزودن</a>
                        </li>
                        <li>
                            <a href="/transaction">لیست</a>
                        </li>
                        <li>
                            <a href="{{ route('transaction.flow') }}">کاریز معاملات</a>
                        </li>
                    </ul>
                </li>
                ...
                کارشناسان
                        ...
                        <div class="rtl:rotate-180"
                             :class="{ '!rotate-90': activeDropdown === 'user' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'user'" x-collapse
                        ...
                        <li>
                            <a href="{{ route('auth::users.index') }}">لیست</a>
                        </li>

                        <li>
                            <a href="{{ route('auth::users.create') }}">افزودن</a>
                        </li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        ...
                        <div class="flex items-center">
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">مشتریان</span>
                        </div>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'customer'" x-collapse
                        class="sub-menu text-gray-500">
                        <li>
                            <a href="/customer">لیست</a>
                        </li>
                        <li>
                            <a href="/customer/create">افزودن</a>
                        </li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                            :class="{ 'active': activeDropdown === 'lead' }"
                            @click="activeDropdown === 'lead' ? activeDropdown = null : activeDropdown = 'lead'">
                        <div class="flex items-center">
                            <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24"
                                 fill="none" xmlns="http://www.w3.org/2000/svg">
                                <!-- نفر اول -->
                                <circle cx="8" cy="8" r="3" fill="currentColor"/>
                                <ellipse cx="8" cy="18" rx="4" ry="2.5" fill="currentColor"/>
                                <!-- نفر دوم (کنار نفر اول) -->
                                <circle cx="16" cy="10" r="2.5" fill="currentColor" opacity="0.6"/>
                                <ellipse cx="16" cy="18" rx="3.5" ry="2" fill="currentColor" opacity="0.6"/>
                                <!-- لیست / لیدهای بیشتر -->
                                <line x1="4" y1="20" x2="20" y2="20" stroke="currentColor" stroke-width="1.5" opacity="0.4" />
                            </svg>
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">لیدها</span>
                        </div>
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'lead' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'lead'" x-collapse
                        class="sub-menu text-gray-500">
                        <li>
                            <a href="/lead">لیست</a>
                        </li>
                        <li>
                            <a href="/lead/create">افزودن</a>
                        </li>
                ...
                <li class="menu nav-item">
                    <button
                        type="button"
                        class="nav-link group w-full"
                        :class="{ 'active' : activeDropdown === 'product' }"
                        @click="activeDropdown === 'product' ? activeDropdown = null : activeDropdown = 'product'">
                        ...
                        <div class="flex items-center">
                            ...
                            <svg class="shrink-0 group-hover:!text-primary" width="20" height="20"
                                 ...
                                 xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5"
                                      d="M3 8L21 8" stroke="currentColor" stroke-width="1.5"
                                      stroke-linecap="round" />
                                <path
                                    d="M3 16L21 16" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" />
                                <path
                                    d="M15 2L15 22" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" />
                            </svg>
                ...
                محصولات
                        ...
                        <div class="rtl:rotate-180"
                             :class="{ '!rotate-90': activeDropdown === 'product' }">
                    ...
                    <!-- Sub Menu -->
                    <ul x-cloak x-show="activeDropdown === 'product'" x-collapse
                        class="sub-menu text-gray-500">

                        <li>
                            <a href="{{ route('products.index') }}">لیست</a>
                        </li>

                        <li>
                            <a href="{{ route('products.create') }}">افزودن</a>
                        </li>
                ...
                <li class="menu nav-item" x-data="{ activeDropdown: null }">
                    <button type="button" class="nav-link group"
                            :class="{ 'active': activeDropdown === 'flow' }"
                            @click="activeDropdown === 'flow' ? activeDropdown = null : activeDropdown = 'flow'">
                        <div class="flex items-center">
                            <!-- آیکون فلوی کاری -->
                ...
                فرایندها
                        ...
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'flow' }">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                      stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <!-- زیرمنو -->
                    <ul x-cloak x-show="activeDropdown === 'flow'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="{{ route('flows.index') }}"
                               class="{{ request()->routeIs('flows.index') ? 'active' : '' }}">
                                لیست فرآیندها
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('flows.create') }}"
                               class="{{ request()->routeIs('flows.create') ? 'active' : '' }}">
                                افزودن فرآیند
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('flows.rules.index') }}"
                               class="{{ request()->routeIs('flows.rules.index') ? 'active' : '' }}">
                                لیست قوانین گردش‌کار
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    <button
                        type="button"
                        class="nav-link group w-full"
                        :class="{ 'active' : activeDropdown === 'task' }"
                        @click="activeDropdown === 'task' ? activeDropdown = null : activeDropdown = 'task'">
                ...
                فعالیت
                        ...
                        <div class="rtl:rotate-180"
                             :class="{ '!rotate-90': activeDropdown === 'task' }">
                    ...
                    <!-- Sub Menu -->
                    <ul x-cloak x-show="activeDropdown === 'task'" x-collapse
                        class="sub-menu text-gray-500">

                        <li>
                            <a href="{{ route('tasks.index') }}">لیست</a>
                        </li>

                        <li>
                            <a href="{{ route('tasks.create') }}">افزودن</a>
                        </li>

                        <li>
                            <a href="{{ route('calendar.view') }}">تقویم فعالیت ها</a>
                        </li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                            :class="{ 'active': activeDropdown === 'ticket' }"
                            @click="activeDropdown === 'ticket' ? activeDropdown = null : activeDropdown = 'ticket'">
                        <div class="flex items-center">
                            <svg class="group-hover:!text-primary shrink-0" width="20" height="20"
                                 viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">تیکت ها</span>
                        </div>
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'ticket' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'ticket'" x-collapse
                        class="sub-menu text-gray-500">
                        <li>
                            <a href="/tickets">لیست</a>
                        </li>
                        <li>
                            <a href="/tickets/create">افزودن</a>
                        </li>
                ...
                <li class="menu nav-item">
                    <a href="{{ route('chats.index') }}"
                       class="nav-link group {{ request()->routeIs('chats.index') ? 'active' : '' }}">
                        <div class="flex items-center">
                            <svg class="group-hover:!text-primary shrink-0" width="20" height="20"
                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
