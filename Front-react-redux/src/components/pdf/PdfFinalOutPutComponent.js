        ...
        <Document>
          <Page size="A4" style={styles.page}>
            <View  style={styles.section}>
              <Text className="p-1 mt-2" style={styles.text}>میزان ریسک پذیریی این دارایی در برابر تهدیداین تهدید در محدوده بسیار بالا قرار دارد</Text>
              <Text >میزان ریسک پذیریی این دارایی در برابر تهدیداین تهدید در محدوده بسیار بالا قرار دارد</Text>
            </View>
          </Page>
        </Document>
      </PDFViewer>
